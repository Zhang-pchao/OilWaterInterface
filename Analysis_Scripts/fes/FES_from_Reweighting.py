...
# grid related
parser.add_argument('--min',dest='grid_min',type=str,default="-3.6,0",help='lower bounds for the grid')
parser.add_argument('--max',dest='grid_max',type=str,default="5.1,2", help='upper bounds for the grid')
