...
data_path = "/data/HOME_BACKUP/pengchao/Oil/deepks/m062x_dataset/2c10h22_44h2o"
#typemap   = ["H","O","N","C"]
#typedict  = {"H": 1, "O": 8.0, "N": 7.0, "C": 6.0}
typemap   = ["H","C","O"]
typedict  = {"H": 1, "C": 6.0, "O": 8.0}
all_dir   = ["007","008"]
for i in all_dir:
    scf_num   = 0
    ...
    save_path1 = os.path.join(data_path,  "ks_dataset/test_30",i)
    mkdir(save_path1)
    ...
    #choose_frames = dir_list[0::2] # train_150
    #choose_frames = dir_list[1::2] # test_150   
    choose_frames = dir_list[1::10] # test_30
    total_xyz     = []
    total_force   = []
    total_energy  = []
