...
public:
  explicit VoronoiIM(const ActionOptions&);
  ~VoronoiIM();
// active methods:
...
PLUMED_REGISTER_ACTION(VoronoiIM,"VORONOIIM")

void VoronoiIM::registerKeywords( Keywords& keys ) {
...
VoronoiIM::VoronoiIM(const ActionOptions&ao):
