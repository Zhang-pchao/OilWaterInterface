...
class VoronoiIPZ : public Colvar {
  bool pbc;
  bool serial;
...
public:
  explicit VoronoiIPZ(const ActionOptions&);
  ~VoronoiIPZ();
// active methods:
...
PLUMED_REGISTER_ACTION(VoronoiIPZ,"VORONOIIPZ")

void VoronoiIPZ::registerKeywords( Keywords& keys ) {
...
VoronoiIPZ::VoronoiIPZ(const ActionOptions&ao):
