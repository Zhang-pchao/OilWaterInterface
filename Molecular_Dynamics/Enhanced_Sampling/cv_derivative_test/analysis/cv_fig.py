...
root= args.directory
data=plumed.read_as_pandas(os.path.join(root,"derivatives"))
savepath="./"

cv_fig(data,["zm06"],["zm06n"],["zm06"],"zm06","zm06n",savepath,1,False)
cv_fig(data,["zp06"],["zp06n"],["zp06"],"zp06","zp06n",savepath,1,False)
cv_fig(data,["c08"],["c08n"],["c08"],"c08","c08n",savepath,1,False)
cv_fig(data,["d08"],["d08n"],["d08"],"d08","d08n",savepath,1,False)
